...
import bgImage from "../assets/Rectangle 4.png";
// var sectionStyle = {
//   width: "100%",
//   height: "100%",
...
const Banner = () => (
  <section  className="bg-red-700 py-32 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})`}} >
    <div className="container mx-auto px-10 flex justify-between relative">
      <div className="text-white flex flex-col justify-center">
        <h1 className="text-wrap font-bold absolute top-11 left-0 text-8xl z-10 bg-red-700 ml-10 uppercase py-4 pr-7 ">Taste The Authentic <br/> Saudi Cuisine</h1>
