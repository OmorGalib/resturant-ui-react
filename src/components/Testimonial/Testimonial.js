  ...
  return (
    <section className="py-28 bg-gray-100">
      <div className="container mx-auto px-10 relative">
        ...
        <h1 className="text-4xl font-bold mb-8 uppercase">What Some of Our Customers Say</h1>
        
        <div className="flex items-center justify-center">
          {/* Slider Content */}
          <div className="test-slide-container flex items-center mt-6 w-full transition-transform duration-700 ease-in-out transform">
            <div className="test-slide-container flex flex-col justify-between bg-yellow-400 p-20 w-5/12 h-full relative">
              <div>
              ...
              <img src={leafShape} alt="Leaf Shape" className="absolute bottom-16 left-0 w-10 h-16" />
            </div>

            <div className="test-slide-container w-7/12" >
