  ...
  <section  className="bg-red-700 -mt-32 pb-32 pt-64 bg-no-repeat bg-cover bg-center" style={{ backgroundImage: `url(${bgImage})`}} >
    <div className="container mx-auto px-10 flex justify-between relative">
      <div className="text-white flex flex-col justify-center">
        <h1 className="bg-gradient-to-r from-transparent to-red-700/50 text-wrap font-bold absolute top-11 left-0 text-7xl z-10  ml-10 uppercase py-4 pr-7 ">Taste The Authentic <br/> Saudi Cuisine</h1>
